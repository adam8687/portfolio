...
organizations:
  - name: Westlake High School
    url: https://whs.eanesisd.net/

# Social network links
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'mailto:adammohn06@gmail.com'
    label: E-mail Me
  - icon: brands/x
  ...
  - icon: brands/github
    url: https://github.com/adam8687
  - icon: brands/linkedin
    url: https://www.linkedin.com/in/adam-mohiuddin-801900222/
...
education:
  - area: Artificial Intelligence
    institution: West Lake High School
